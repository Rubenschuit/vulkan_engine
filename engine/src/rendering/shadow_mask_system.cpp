...
ShadowMaskSystem::ShadowMaskSystem(
	...
	event_bus.subscribe<ShadowMaskResolutionChangedEvent>([this](const ShadowMaskResolutionChangedEvent& e) {
		recreate(e.pool, e.mask_extent, e.depth_extent, e.depth_image_view, e.depth_image);
	});
